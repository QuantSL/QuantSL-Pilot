...
void qdsl::ITensorIndexVisitor::_generateParameterCheck() {
...
antlrcpp::Any qdsl::ITensorIndexVisitor::visitMain(QDSLParser::MainContext *ctx) {
  _indexSampler = "";
...
antlrcpp::Any qdsl::ITensorIndexVisitor::visitParameters(QDSLParser::ParametersContext *ctx) {
...
antlrcpp::Any qdsl::ITensorIndexVisitor::visitSubsystems(QDSLParser::SubsystemsContext *ctx) {
...
antlrcpp::Any qdsl::ITensorIndexVisitor::visitSimpleDefinition(qdsl::QDSLParser::SimpleDefinitionContext *ctx) {
  _indentation = "\t";
...
antlrcpp::Any qdsl::ITensorIndexVisitor::visitIndexedDefinition(qdsl::QDSLParser::IndexedDefinitionContext *ctx) {
  _indentation += "\t";
...
antlrcpp::Any qdsl::ITensorIndexVisitor::visitSumExpression(qdsl::QDSLParser::SumExpressionContext *ctx) {
  std::vector<std::string> indices;
...
antlrcpp::Any qdsl::ITensorIndexVisitor::visitElementaryExpression(qdsl::QDSLParser::ElementaryExpressionContext *ctx) {
  std::vector<std::string> indices;
