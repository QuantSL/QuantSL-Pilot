...
if(ANTLR_EXECUTABLE AND Java_JAVA_EXECUTABLE)
  ...
  macro(ANTLR_TARGET Name InputFile)
    ...
    set(ANTLR_ONE_VALUE_ARGS PACKAGE OUTPUT_DIRECTORY DEPENDS_ANTLR LOCATION)
    ...
    if(ANTLR_TARGET_DEPENDS_ANTLR)
      if(ANTLR_${ANTLR_TARGET_DEPENDS_ANTLR}_INPUT)
        if(ANTLR_TARGET_LOCATION)
          list(APPEND ANTLR_TARGET_DEPENDS
              ${ANTLR_TARGET_LOCATION}/${ANTLR_${ANTLR_TARGET_DEPENDS_ANTLR}_INPUT})
        else()
          list(APPEND ANTLR_TARGET_DEPENDS
    ...
    if(ANTLR_TARGET_LOCATION)
      set(GRAMMAR_DIR  ${CMAKE_CURRENT_SOURCE_DIR}/${ANTLR_TARGET_LOCATION})
      set(GRAMMAR_DEPS ${ANTLR_TARGET_LOCATION}/${InputFile})
    else()
      set(GRAMMAR_DIR  ${CMAKE_CURRENT_SOURCE_DIR})
      set(GRAMMAR_DEPS ${InputFile})
    endif()
    add_custom_command(
